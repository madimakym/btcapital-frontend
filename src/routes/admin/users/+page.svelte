...
<div class="max-w-6xl mx-auto space-y-6">
  <PageHeader title="Gestion des utilisateurs" description="" />
  <!-- {#if error}
              ...
              {#each data.content as user}
                <tr class="hover">
                  <td>
                    <div class="flex items-center gap-3">
                      <div class="avatar placeholder">
                        <div
                          class="bg-primary/10 text-primary rounded-full w-9 flex items-center justify-center"
                        >
                  ...
                  <td>
                    {#if user.role !== "ADMIN"}
                      <button
                        class="btn btn-xs {user.status === 'ACTIVE'
                          ? 'btn-error'
                          : 'btn-success'}"
